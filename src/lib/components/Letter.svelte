<!-- File: src/lib/components/Letter.svelte -->
<svelte:head>
...
<script lang="ts">
  ...
  export let offerNumber: string = '[E-yyyy-num]';
...
<div class="page-wrapper">
  <div class="a4-container">
    <div class="content">
      ...
      <div class="Estimate-num">ESTIMATE No.: {offerNumber}</div>
      <div class="date">DATE:&nbsp;&nbsp;{offerDate}</div>

      <div class="intro-text">ESTIMATE<br /></div>
      ...
      <div class="footer-text">
        The estimate provided is based on the information given at the time of the estimate, and is subject to change.<br />
