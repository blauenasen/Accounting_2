<!-- Modul: src/routes/debtors/+page.svelte -->
...
<script lang="ts">
  ...
  async function speichern() {
    ...
    if (selectedIndex === null) {
      ...
      if (isNaN(accNum) || accNum < 10000 || accNum > 69999) {
        alert('Account number must be an integer between 10000 and 69999.');
        return;
      }
    ...
    if (!confirm('Save or update debtor?')) return;
...
<h1 class="debtors-header">DEBTORS</h1>

<div class="debtors-button-container">
